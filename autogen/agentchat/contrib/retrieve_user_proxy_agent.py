...
If you can't answer the question with or without the current context, you should reply exactly `Answer cannot be ascertained because not enough relevant information is provided in the document`.
